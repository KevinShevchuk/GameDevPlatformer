...
public class BricksManager
{
  ...
  private final static int MAX_BRICKS_LINES = 24;
  ...
  */
  {
    if (insideBrick(xWorld, yWorld)) {
      int yMapWorld = yWorld - (pHeight-height);
      //System.out.print("yMapWorld: " + yMapWorld);
      int mapY = (int) (yMapWorld/imHeight);  // map y- index
      //System.out.print("\tmapY: " + mapY);
      int topOffset = yMapWorld - (mapY * imHeight);
      //System.out.print("\ttop offset: " + topOffset);
      int smallStep = step - topOffset;
      //System.out.print("\t\ttop smallStep: " + smallStep);
      return smallStep;
    }
    return step;   // no change
